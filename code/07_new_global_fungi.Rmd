...
write_tsv(dat, paste0(temp_out, "prev_fungi_species.tsv"))

dat <- data.frame(pre = rowSums(ft_ITS_clean_wk_g>0), taxa = rownames(ft_ITS_clean_wk_g))
write_tsv(dat, paste0(temp_out, "prev_fungi_genus.tsv"))
