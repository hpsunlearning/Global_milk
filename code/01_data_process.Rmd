...
temp <- read_excel("~/Dropbox/Rutgers/20220304_Milk_inventory/ITS_sent/Metadata_global_milk_platemap.xlsx", sheet = "Global_milk_sample_mapping")
...
temp <- taxa %>% filter(id %in% unique(unlist(lst))) %>% 
  ...
  select(id, taxa_long, prev, combined, minimum, either, both)
