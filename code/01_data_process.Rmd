...
country_font_color = c("Guinea Ecuatorial"="#1b9e77", "Kenya"="#1b9e77", "Senegal"="#1b9e77", "South Sudan"="#1b9e77", "Tanzania"="#1b9e77",
...
rm(contamdf, contam_id, a1, a2, a3, a4, prev, combined, minimum, either, both, lst, temp)
```
