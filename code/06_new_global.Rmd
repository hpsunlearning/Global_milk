...
meta_global_rf %>% count(Country)
meta_global_rf %>% count(Continent)
meta_global_rf %>% count(Birth_mode)

meta_global_rf %>% summarise(my_summarize(Maternal_age))
meta_global_rf %>% summarise(my_summarize(Maternal_weight_kg))
meta_global_rf %>% summarise(my_summarize(Maternal_height_cm))
meta_global_rf %>% summarise(my_summarize(Maternal_BMI))
meta_global_rf %>% summarise(my_summarize(Time_post_partum_day))
