...
write.csv(alpha_lm_coef, row.names = FALSE,
          file = paste0(temp_out,"alpha_lm_global_project_Country_conc_method_all_coef.csv"))
...
write.csv(alpha_lm_omega, row.names = FALSE,
          file = paste0(temp_out,"alpha_lm_global_project_Country_conc_method_all_omega.csv"))
...
write.csv(alpha_lm_coef, row.names = FALSE,
          file = paste0(temp_out,"alpha_lm_global_project_Continent_conc_method_all_coef.csv"))
...
write.csv(alpha_lm_omega, row.names = FALSE,
          file = paste0(temp_out,"alpha_lm_global_project_Continent_conc_method_all_omega.csv"))
